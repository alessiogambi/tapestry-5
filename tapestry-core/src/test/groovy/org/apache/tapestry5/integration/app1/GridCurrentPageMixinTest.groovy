...
class GridCurrentPageMixinTest extends SeleniumTestCase
{
    ...
    void page_parameter_is_added_to_url() {
        ...
        openLinks "GridCurrentPage Mixin Demo"
        ...
        // reset grid1
         ...
         assertTrue getLocation().endsWith("gridcurrentpagemixindemo")
    }
    ...
    void provide_page_number_in_url_both_grids() {
        ...
        // the URL parameter for grid1 should not be there anymore, but for grid2 should be still there
        assertTrue getLocation().endsWith("?grid2.page=3")
        
        // reset grid2
        clickAndWait "link=reset Grid2"
        
        // the URL parameter for grid2 should not be there anymore
        assertTrue getLocation().endsWith("gridcurrentpagemixindemo")
    }
}
